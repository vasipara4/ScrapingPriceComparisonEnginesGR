...
SKROUTZ_URL = 'https://www.skroutz.gr/s/7092520/Seagate-Expansion-Portable-2TB-STEA2000400.html'
BESTPRICE_URL = "https://www.bestprice.gr/item/2154674735/seagate-expansion-portable-2tb-black.html"
DESIRED_PRICE = 55.00
...
# Skroutz Section
if(SKROUTZ_URL != None) : 
	Skroutz_page = requests.get(SKROUTZ_URL)
...
if DESIRED_PRICE < min(skroutz_price,bestprice_price):
	if skroutz_price<=bestprice_price:
		print("Price DROP in Skroutz! Check it")
